...
RESOURCES += src/qt/cnsc.qrc src/qt/cnsc_locale.qrc

TRANSLATIONS += src/qt/locale/cnsc_bg.ts \
                src/qt/locale/cnsc_de.ts \
                src/qt/locale/cnsc_en.ts \
                src/qt/locale/cnsc_es.ts \
                src/qt/locale/cnsc_fi.ts \
                src/qt/locale/cnsc_fr.ts \
                src/qt/locale/cnsc_it.ts \
                src/qt/locale/cnsc_ja.ts \
                src/qt/locale/cnsc_pl.ts \
                src/qt/locale/cnsc_pt.ts \
                src/qt/locale/cnsc_ru.ts \
                src/qt/locale/cnsc_sk.ts \
                src/qt/locale/cnsc_sv.ts \
                src/qt/locale/cnsc_vi.ts \
                src/qt/locale/cnsc_zh_CN.ts \
                src/qt/locale/cnsc_zh_TW.ts
