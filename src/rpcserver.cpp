...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CNSC features */
        {"cnsc", "masternode", &masternode, true, true, false},
        {"cnsc", "masternodelist", &masternodelist, true, true, false},
        {"cnsc", "mnbudget", &mnbudget, true, true, false},
        {"cnsc", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cnsc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cnsc", "mnsync", &mnsync, true, true, false},
        {"cnsc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cnscd, or the -server option to cnsc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cnsc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17778/\n";
}
