...
{
    const char* pszTimestamp = "Crown Service Coin";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
		(0, uint256("0x0000055cb93c07953cc2e3da246450bc45224026e13d4e40d90a258b378b9751"))
		;
...
public:
    CMainParams()
    {
        ...
        nMasternodeColleteralLimxDev = 8000;
        nModifierUpdateBlock = 1;
        nMaxMoneyOut = 700000000 * COIN;
		
        genesis = CreateGenesisBlock(1543476252, 20946533, 0x1e0ffff0, 1, 0 * COIN);

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x0000055cb93c07953cc2e3da246450bc45224026e13d4e40d90a258b378b9751"));
        assert(genesis.hashMerkleRoot == uint256("0x4a647b76f8a8107fca6b0c12697cde5eedb801112afa4628b80d11114e8d66a9"));
		
	vSeeds.push_back(CDNSSeedData("s1.crownservice.io", "s1.crownservice.io"));
	vSeeds.push_back(CDNSSeedData("s2.crownservice.io", "s2.crownservice.io"));
	vSeeds.push_back(CDNSSeedData("s3.crownservice.io", "s3.crownservice.io"));
	...
	nStartMasternodePayments = 1543476252; 
