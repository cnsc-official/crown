                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CROWNSERVICECOIN-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CNSC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cnsc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CNSC Core"), this);
    aboutAction->setStatusTip(tr("Show information about CNSC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CNSC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CNSC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CNSC addresses"));
    ...
    openAction->setStatusTip(tr("Open a CNSC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CNSC Core help message to get a list with possible CNSC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CNSC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CNSC network", "", count));
}
...
{
    QString strTitle = tr("CNSC Core"); // default title
