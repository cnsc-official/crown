/* src/config/cnsc-config.h.  Generated from cnsc-config.h.in by configure.  */
/* src/config/cnsc-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CNSC_CONFIG_H

#define CNSC_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://bit.cnscs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CNSC Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CNSC Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cnsc"
