...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CNSC Core cnsc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cnsc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cnsc transaction") + "\n" +
                               "  cnsc-tx [options] -create [commands]   " + _("Create hex-encoded cnsc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cnsc transaction
