...
#if defined(NDEBUG)
#error "CNSC cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "CNSC Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight > 1 && nHeight <= 17777) {
		nSubsidy = 1 * COIN;
	} else if (nHeight > 17778 && nHeight <= 47777) {
		nSubsidy = 47 * COIN;
	} else if (nHeight > 47778 && nHeight <= 67777) {
		nSubsidy = 67 * COIN;
	} else if (nHeight > 67778 && nHeight <= 87777) {
		nSubsidy = 97 * COIN;
	} else if (nHeight > 87778) {
		nSubsidy = 37 * COIN;
	}
    return nSubsidy;
}
