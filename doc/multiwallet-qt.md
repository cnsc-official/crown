...
In order to support loading of multiple wallets in cnsc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cnsc.cpp.
...
Changes to cnsc.cpp
----------------------
cnsc.cpp is the entry point into cnsc-qt, and as such, will require some minor modifications to provide hooks for
